    ...
    private void initData() {
        ...
        mAdapter.setItemOnClickListener(new MyItemOnClickListener() {
            ...
            public void onItemOnClick(View view, String merchantID) {
                ...
                intent.putExtra("userid", Hawk.get("userid").toString());
                intent.putExtra("username", Hawk.get("username").toString());
                intent.putExtra("userphone", Hawk.get("userphone").toString());
                intent.putExtra("userhead", Hawk.get("userhead").toString());
