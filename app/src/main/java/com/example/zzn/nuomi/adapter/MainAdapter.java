...
import com.example.zzn.nuomi.common.Localize;
import com.example.zzn.nuomi.common.http.GankUrl;
        ...
        switch (viewType) {
            ...
            case TYPE_HEAD:
                if (getWeekDay(0).equals("周一")){
                    ...
                    return new HolderType3(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_head_2, parent, false));
                }else  if (getWeekDay(0).equals("周三")){
                    return new HolderType3(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_head_3, parent, false));
                }else if (getWeekDay(0).equals("周四")){
                    return new HolderType3(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_head_4, parent, false));
                }else if (getWeekDay(0).equals("周五")){
                    return new HolderType3(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_head_5, parent, false));
                }else if (getWeekDay(0).equals("周六")){
                    return new HolderType3(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_head_6, parent, false));
                }else if (getWeekDay(0).equals("周日")){
                    return new HolderType3(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_head_7, parent, false));
                }
            case TYPE_HEAD2:
