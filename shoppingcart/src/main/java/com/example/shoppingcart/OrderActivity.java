...
public class OrderActivity extends AppCompatActivity {
    ...
    private String arr,orderinfo,cost,merchantID,userid,username,userimg,userphone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userimg=intent.getStringExtra("userhead");
        userphone=intent.getStringExtra("userphone");
//        Log.e("test3",username);
        ...
        pay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        post(orderinfo,cost,merchantID,userid,username,userimg,userphone);
                    }
                }).start();
//               finish();
            }
    ...
    private String post(String orderinfo, String cost,String merchantID,String userid,String username,String userimg,String userphone) {
        ...
        try {
            ...
            String data =orderinfo.replaceAll("￥","￥")+"$"+cost.split("￥")[1]+"$"+merchantID+"$"+
                    userid+"$"+username+"$"+userphone+"$"+userimg;
            //至少要设置的两个请求头
